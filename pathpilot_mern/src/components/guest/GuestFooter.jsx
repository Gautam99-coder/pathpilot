        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-neutral-500 font-medium">
              <li><Link to="/guest/career-paths" className="hover:text-[#1313ec] transition-colors">Career Paths</Link></li>
              <li><Link to="/guest/resources" className="hover:text-[#1313ec] transition-colors">Resources</Link></li>
              <li><Link to="/guest/features" className="hover:text-[#1313ec] transition-colors">Features</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-neutral-500 font-medium">
              <li><Link to="/guest/about" className="hover:text-[#1313ec] transition-colors">About Us</Link></li>
              <li><a href="#" className="hover:text-[#1313ec] transition-colors">Careers</a></li>
              <li><Link to="/guest/contact" className="hover:text-[#1313ec] transition-colors">Contact</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-neutral-500 font-medium">
              <li><a href="/guest/contact" className="hover:text-[#1313ec] transition-colors">Help Center</a></li>
              <li><a href="/guest/contact" className="hover:text-[#1313ec] transition-colors">Terms of Service</a></li>
              <li><a href="/guest/contact" className="hover:text-[#1313ec] transition-colors">Privacy Policy</a></li>
            </ul>
          </div>
        </div>

        <div className="border-t border-neutral-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-neutral-400 text-xs font-bold uppercase tracking-tighter">© 2026 PathPilot. Crafted for future engineers.</p>
          <div className="flex items-center gap-2 bg-green-50 px-3 py-1 rounded-full border border-green-100">
            <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse"></span>
            <span className="text-green-600 text-[10px] font-black uppercase tracking-widest">Global Systems Online</span>
          </div>
        </div>
      </div>
    </footer>
